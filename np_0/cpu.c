...
#define mem8(a) *((CHAR*)(a))
#define mem16(a) *((SHORTINT*)(a))
#define mem32(a) *((INTEGER*)(a))
#define mem64(a) *((LONGINT*)(a))
...
void cpu_execute(INTEGER entry_point, modulename_provider find_modulename)
{
	...
	while (reg[PC]) {
		...
		case SYS + 0:
			printf("Assertion failed in module %s line %i\n",
				find_modulename(), (INTEGER)reg[opc.a]);
			exit(1);
			break;
		...
		case SYS + 13: case SYS + 14: case SYS + 15: case SYS + 16:
			*((LONGINT*)reg[opc.a]) = sys_call(opc.oc - SYS, reg[opc.b]);
			break;
		}
	}
}
