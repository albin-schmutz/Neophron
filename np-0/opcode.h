...
#define OC_LOG_OC_OFFS(pc, opc, reg) oc_log_oc_offs(pc, opc, reg)
#define OC_LOG_OC_A_B_IMM(pc, opc, reg) oc_log_oc_a_b_imm(pc, opc, reg)
#define OC_LOG_OC_A_B_IMM_2(pc, opc, addr, reg) oc_log_oc_a_b_imm_2(pc, opc, addr, reg)
#define OC_LOG_OC_A_IMM(pc, opc, reg) oc_log_oc_a_imm(pc, opc, reg)
#define OC_LOG_OC_A_B(pc, opc, reg) oc_log_oc_a_b(pc, opc, reg)
#define OC_LOG_OC_A_B_C(pc, opc, a, reg) oc_log_oc_a_b_c(pc, opc, a, reg)
...
#define OC_LOG_OC_OFFS(pc, opc, reg)
#define OC_LOG_OC_A_B_IMM(pc, opc, reg)
#define OC_LOG_OC_A_B_IMM_2(pc, opc, addr, reg)
#define OC_LOG_OC_A_IMM(pc, opc, reg)
#define OC_LOG_OC_A_B(pc, opc, reg)
#define OC_LOG_OC_A_B_C(pc, opc, a, reg)

#endif

extern void oc_offs(OPCODE opc);
extern void oc_a_b_imm(OPCODE opc);
extern void oc_a_b_c(OPCODE opc);
extern void oc_instr(OPCODE opc);
